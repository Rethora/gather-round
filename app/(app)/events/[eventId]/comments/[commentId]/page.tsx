...
import { getEvents } from "@/lib/api/events/queries";import OptimisticComment from "@/app/(app)/comments/[commentId]/OptimisticComment";
  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="relative">
        ...
        <OptimisticComment comment={comment} events={events}
        eventId={comment.eventId} />
      </div>
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{comment.content}&apos;s Mentions</h3>
        <MentionList
          comments={[]}
